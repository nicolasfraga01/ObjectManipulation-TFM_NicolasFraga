...
static const _GetMotionInfo_Event_type_support_symbol_names_t _GetMotionInfo_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, play_motion2_msgs, srv, GetMotionInfo_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, play_motion2_msgs, srv, GetMotionInfo_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, play_motion2_msgs, srv, GetMotionInfo_Event)() {
  return &::play_motion2_msgs::srv::rosidl_typesupport_c::GetMotionInfo_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetMotionInfo_service_type_support_handle = {
  ...
  &GetMotionInfo_Request_message_type_support_handle,
  &GetMotionInfo_Response_message_type_support_handle,
  &GetMotionInfo_Event_message_type_support_handle,
