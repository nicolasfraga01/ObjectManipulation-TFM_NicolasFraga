...
static const _RemoveMotion_Event_type_support_symbol_names_t _RemoveMotion_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, play_motion2_msgs, srv, RemoveMotion_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, play_motion2_msgs, srv, RemoveMotion_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, play_motion2_msgs, srv, RemoveMotion_Event)() {
  return &::play_motion2_msgs::srv::rosidl_typesupport_c::RemoveMotion_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t RemoveMotion_service_type_support_handle = {
  ...
  &RemoveMotion_Request_message_type_support_handle,
  &RemoveMotion_Response_message_type_support_handle,
  &RemoveMotion_Event_message_type_support_handle,
