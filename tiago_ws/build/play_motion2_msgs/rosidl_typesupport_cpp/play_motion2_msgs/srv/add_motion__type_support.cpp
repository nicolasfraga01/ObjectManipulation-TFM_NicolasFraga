...
static const _AddMotion_Event_type_support_symbol_names_t _AddMotion_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, play_motion2_msgs, srv, AddMotion_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, play_motion2_msgs, srv, AddMotion_Event)),
  }
};
...
{
  return &::play_motion2_msgs::srv::rosidl_typesupport_cpp::AddMotion_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, play_motion2_msgs, srv, AddMotion_Event)() {
  return get_message_type_support_handle<play_motion2_msgs::srv::AddMotion_Event>();
}
...
static const rosidl_service_type_support_t AddMotion_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<play_motion2_msgs::srv::AddMotion_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<play_motion2_msgs::srv::AddMotion_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<play_motion2_msgs::srv::AddMotion_Event>(),
