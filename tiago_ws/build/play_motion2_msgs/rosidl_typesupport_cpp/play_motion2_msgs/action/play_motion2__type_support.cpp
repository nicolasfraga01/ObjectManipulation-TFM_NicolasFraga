...
static const _PlayMotion2_SendGoal_Event_type_support_symbol_names_t _PlayMotion2_SendGoal_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, play_motion2_msgs, action, PlayMotion2_SendGoal_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, play_motion2_msgs, action, PlayMotion2_SendGoal_Event)),
  }
};
...
{
  return &::play_motion2_msgs::action::rosidl_typesupport_cpp::PlayMotion2_SendGoal_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, play_motion2_msgs, action, PlayMotion2_SendGoal_Event)() {
  return get_message_type_support_handle<play_motion2_msgs::action::PlayMotion2_SendGoal_Event>();
}
...
static const rosidl_service_type_support_t PlayMotion2_SendGoal_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<play_motion2_msgs::action::PlayMotion2_SendGoal_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<play_motion2_msgs::action::PlayMotion2_SendGoal_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<play_motion2_msgs::action::PlayMotion2_SendGoal_Event>(),
...
static const _PlayMotion2_GetResult_Event_type_support_symbol_names_t _PlayMotion2_GetResult_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, play_motion2_msgs, action, PlayMotion2_GetResult_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, play_motion2_msgs, action, PlayMotion2_GetResult_Event)),
  }
};
...
{
  return &::play_motion2_msgs::action::rosidl_typesupport_cpp::PlayMotion2_GetResult_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, play_motion2_msgs, action, PlayMotion2_GetResult_Event)() {
  return get_message_type_support_handle<play_motion2_msgs::action::PlayMotion2_GetResult_Event>();
}
...
static const rosidl_service_type_support_t PlayMotion2_GetResult_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_service_typesupport_handle_function,
  ::rosidl_typesupport_cpp::get_message_type_support_handle<play_motion2_msgs::action::PlayMotion2_GetResult_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<play_motion2_msgs::action::PlayMotion2_GetResult_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<play_motion2_msgs::action::PlayMotion2_GetResult_Event>(),
