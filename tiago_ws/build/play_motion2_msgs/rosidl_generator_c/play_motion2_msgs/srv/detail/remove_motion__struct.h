...
enum
{
  play_motion2_msgs__srv__RemoveMotion_Event__request__MAX_SIZE = 1
};
// response
enum
{
  play_motion2_msgs__srv__RemoveMotion_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/RemoveMotion in the package play_motion2_msgs.
typedef struct play_motion2_msgs__srv__RemoveMotion_Event
{
  service_msgs__msg__ServiceEventInfo info;
  play_motion2_msgs__srv__RemoveMotion_Request__Sequence request;
  play_motion2_msgs__srv__RemoveMotion_Response__Sequence response;
} play_motion2_msgs__srv__RemoveMotion_Event;

// Struct for a sequence of play_motion2_msgs__srv__RemoveMotion_Event.
typedef struct play_motion2_msgs__srv__RemoveMotion_Event__Sequence
{
