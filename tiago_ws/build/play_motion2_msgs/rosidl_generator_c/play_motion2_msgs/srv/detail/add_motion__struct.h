...
enum
{
  play_motion2_msgs__srv__AddMotion_Event__request__MAX_SIZE = 1
};
// response
enum
{
  play_motion2_msgs__srv__AddMotion_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/AddMotion in the package play_motion2_msgs.
typedef struct play_motion2_msgs__srv__AddMotion_Event
{
  service_msgs__msg__ServiceEventInfo info;
  play_motion2_msgs__srv__AddMotion_Request__Sequence request;
  play_motion2_msgs__srv__AddMotion_Response__Sequence response;
} play_motion2_msgs__srv__AddMotion_Event;

// Struct for a sequence of play_motion2_msgs__srv__AddMotion_Event.
typedef struct play_motion2_msgs__srv__AddMotion_Event__Sequence
{
