...
class Metaclass_AddMotion_Event(type):
    """Metaclass of message 'AddMotion_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__add_motion__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__add_motion__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__add_motion__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__add_motion__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__add_motion__event
...
class AddMotion_Event(metaclass=Metaclass_AddMotion_Event):
    """Message class 'AddMotion_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<play_motion2_msgs/AddMotion_Request, 1>',
        'response': 'sequence<play_motion2_msgs/AddMotion_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['play_motion2_msgs', 'srv'], 'AddMotion_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['play_motion2_msgs', 'srv'], 'AddMotion_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from play_motion2_msgs.srv import AddMotion_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, AddMotion_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'AddMotion_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from play_motion2_msgs.srv import AddMotion_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, AddMotion_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'AddMotion_Response'"
...
class Metaclass_AddMotion(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _add_motion.Metaclass_AddMotion_Event._TYPE_SUPPORT is None:
                _add_motion.Metaclass_AddMotion_Event.__import_type_support__()
...
class AddMotion(metaclass=Metaclass_AddMotion):
    ...
    from play_motion2_msgs.srv._add_motion import AddMotion_Event as Event
