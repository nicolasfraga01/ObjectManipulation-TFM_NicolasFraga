...
class Metaclass_GetMotionInfo_Event(type):
    """Metaclass of message 'GetMotionInfo_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_motion_info__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_motion_info__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_motion_info__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_motion_info__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_motion_info__event
...
class GetMotionInfo_Event(metaclass=Metaclass_GetMotionInfo_Event):
    """Message class 'GetMotionInfo_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<play_motion2_msgs/GetMotionInfo_Request, 1>',
        'response': 'sequence<play_motion2_msgs/GetMotionInfo_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['play_motion2_msgs', 'srv'], 'GetMotionInfo_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['play_motion2_msgs', 'srv'], 'GetMotionInfo_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from play_motion2_msgs.srv import GetMotionInfo_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetMotionInfo_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetMotionInfo_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from play_motion2_msgs.srv import GetMotionInfo_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetMotionInfo_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetMotionInfo_Response'"
...
class Metaclass_GetMotionInfo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_motion_info.Metaclass_GetMotionInfo_Event._TYPE_SUPPORT is None:
                _get_motion_info.Metaclass_GetMotionInfo_Event.__import_type_support__()
...
class GetMotionInfo(metaclass=Metaclass_GetMotionInfo):
    ...
    from play_motion2_msgs.srv._get_motion_info import GetMotionInfo_Event as Event
