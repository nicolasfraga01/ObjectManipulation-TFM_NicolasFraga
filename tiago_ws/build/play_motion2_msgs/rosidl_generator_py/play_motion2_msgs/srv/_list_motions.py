...
class Metaclass_ListMotions_Event(type):
    """Metaclass of message 'ListMotions_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__list_motions__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__list_motions__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__list_motions__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__list_motions__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__list_motions__event
...
class ListMotions_Event(metaclass=Metaclass_ListMotions_Event):
    """Message class 'ListMotions_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<play_motion2_msgs/ListMotions_Request, 1>',
        'response': 'sequence<play_motion2_msgs/ListMotions_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['play_motion2_msgs', 'srv'], 'ListMotions_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['play_motion2_msgs', 'srv'], 'ListMotions_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from play_motion2_msgs.srv import ListMotions_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListMotions_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ListMotions_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from play_motion2_msgs.srv import ListMotions_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListMotions_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ListMotions_Response'"
...
class Metaclass_ListMotions(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _list_motions.Metaclass_ListMotions_Event._TYPE_SUPPORT is None:
                _list_motions.Metaclass_ListMotions_Event.__import_type_support__()
...
class ListMotions(metaclass=Metaclass_ListMotions):
    ...
    from play_motion2_msgs.srv._list_motions import ListMotions_Event as Event
