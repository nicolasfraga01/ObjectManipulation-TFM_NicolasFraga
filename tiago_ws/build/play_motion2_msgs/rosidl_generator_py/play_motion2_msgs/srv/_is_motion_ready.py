...
class Metaclass_IsMotionReady_Event(type):
    """Metaclass of message 'IsMotionReady_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__is_motion_ready__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__is_motion_ready__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__is_motion_ready__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__is_motion_ready__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__is_motion_ready__event
...
class IsMotionReady_Event(metaclass=Metaclass_IsMotionReady_Event):
    """Message class 'IsMotionReady_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<play_motion2_msgs/IsMotionReady_Request, 1>',
        'response': 'sequence<play_motion2_msgs/IsMotionReady_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['play_motion2_msgs', 'srv'], 'IsMotionReady_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['play_motion2_msgs', 'srv'], 'IsMotionReady_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from play_motion2_msgs.srv import IsMotionReady_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, IsMotionReady_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'IsMotionReady_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from play_motion2_msgs.srv import IsMotionReady_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, IsMotionReady_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'IsMotionReady_Response'"
...
class Metaclass_IsMotionReady(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _is_motion_ready.Metaclass_IsMotionReady_Event._TYPE_SUPPORT is None:
                _is_motion_ready.Metaclass_IsMotionReady_Event.__import_type_support__()
...
class IsMotionReady(metaclass=Metaclass_IsMotionReady):
    ...
    from play_motion2_msgs.srv._is_motion_ready import IsMotionReady_Event as Event
